...
*/}
      ...
      <section className="relative bg-[url(https://www.minecraft.net/content/dam/games/minecraft/key-art/Vanilla-PMP_Collection-Carousel-0_Update-Aquatic_1280x768.jpg)] bg-cover bg-center bg-no-repeat">

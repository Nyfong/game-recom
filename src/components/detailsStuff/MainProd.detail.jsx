...
let MainProdDetail = async ({ detialsPropId }) => {
  ...
  // Find the specific product by id or index
  const detailData = fetchData.find((product) => product._id === detialsPropId);

  // If the product is not found, you can show an error or message
  if (!detailData) {
